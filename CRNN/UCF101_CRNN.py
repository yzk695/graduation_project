...
# set path
data_path = "G:\\Graduation_Project\\video-classification-master\\UCF50\\"    # define UCF-101 RGB data path
action_name_path = "G:\\Graduation_Project\\video-classification-master\\CRNN\\UCF101actions.pkl"
