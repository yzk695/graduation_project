...
# set path
data_path = "G:/Graduation_Project/video-classification-master/jpegs_256/"    # define UCF-101 RGB data path
action_name_path = 'G:\Graduation_Project/video-classification-master/ResNetCRNN/UCF101actions.pkl'
save_model_path = "G:/Graduation_Project/video-classification-master/ResNetCRNN_ckpt/"
...
def train(log_interval, model, device, train_loader, optimizer, epoch):
    ...
    for batch_idx, (X, y) in enumerate(train_loader):
        ...
        # pdb.set_trace()
        step_score = accuracy_score(y.cpu().data.tolist(), y_pred.cpu().data.tolist())
